...
def main(api_endpoint, credentials, project_id,
    ...
    def volume(isPercentage, volumeRelativeLevel):
        if isPercentage:
            logging.info('Turning device isPercentage')
            # logging.warning('U CAN DO SOMETHING IN THERE FOR ON!!!')
            print(volumeRelativeLevel)
        else:
            logging.info('Turning device not isPercentage')
            # logging.warning('U CAN DO SOMETHING IN THERE FOR OFF!!!')
            print("OFF")
    ...
    def blink(speed, number):
        ...
        if speed == "SLOWLY":
            delay = 2
            # logging.info('Blinking device SLOWLY.')
        elif speed == "QUICKLY":
            delay = 0.5
            # logging.info('Blinking device QUICKLY.')
